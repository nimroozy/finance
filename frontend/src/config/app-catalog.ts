...
/**
 * Stage 9.1 unified app catalog.
 * Only routes that exist on the stage-9 branch — no Stage 10 Services/Radius apps.
 */
...
export const APP_CONTEXT_NAV: Record<string, AppNavItem[]> = {
  ...
  noc: [{ href: "/noc/dashboard", labelKey: "nocDashboard", permissions: ["escalations.view", "dashboard.view"] }],
  installations: [
...
export const BOTTOM_NAV_BY_ROLE: Record<LauncherRole, string[]> = {
  ...
  noc: ["noc", "tasks", "support", "sites", "apps"],
